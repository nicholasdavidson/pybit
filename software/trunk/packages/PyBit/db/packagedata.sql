...
CREATE TABLE PackageInstance ( 
	...
	Dist_id bigint,
	Format_id bigint,
	master boolean NOT NULL    --  Master tell us if this instance is the first submitted for a given package, this information is acted on by certain build clients 
)
;
...
ALTER TABLE Arch ADD CONSTRAINT PK_Arch 
	PRIMARY KEY (id)
;


ALTER TABLE BuildClients ADD CONSTRAINT PK_BuildClients 
	PRIMARY KEY (id)
;


ALTER TABLE Distribution ADD CONSTRAINT PK_Distribution 
	PRIMARY KEY (id)
;
...
ALTER TABLE JobStatus ADD CONSTRAINT PK_JobStatus 
	PRIMARY KEY (id)
;
...
ALTER TABLE PackageInstance ADD CONSTRAINT PK_PackageInstance 
	PRIMARY KEY (id)
;
...
ALTER TABLE Suite ADD CONSTRAINT PK_Suite 
	PRIMARY KEY (id)
;
